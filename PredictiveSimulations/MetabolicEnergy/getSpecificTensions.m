...
function sigma = getSpecificTensions(muscleNames)
    ...
    sigma_data.bi_fem_lh_r = 0.62222;
    sigma_data.bi_fem_sh_r = 1.00500;
    sigma_data.sartorius_r = 0.74286;
    sigma_data.add_mag1_r = 0.55217;
    sigma_data.add_mag2_r = 0.55323;
    sigma_data.add_mag3_r = 0.54831;
    sigma_data.TFL_r = 0.75161;
    sigma_data.pectineus_r = 0.76000;
    sigma_data.gracilis_r = 0.73636;
    ...
    sigma_data.gemellus_r = 0.74545;
    sigma_data.piri_r = 0.75254;
    sigma_data.rectus_fem_r = 0.74936;
    sigma_data.vas_med_r = 0.49961;
    sigma_data.vas_int_r = 0.55263;
    sigma_data.vas_lat_r = 0.50027;
    sigma_data.gas_med_r = 0.69865;
    sigma_data.gas_lat_r = 0.69694;
